...
public class ProcessedRevenueDomain extends Auditable<String>{
    ...
    private StoreDomain locationDomain;
    private Date date;
    ...
    public ProcessedRevenueDomain(EnteredRevenueDomain enteredRevenue, Date date, StoreDomain location, double actualIntake, double tapeIntake, double overUnder, double taxCount, double valuePerTransaction, double percentageCard, double percentageCash, double percentageCheck) {
    ...
    public StoreDomain getLocationDomain() {
        return locationDomain;
    }

    public void setLocationDomain(StoreDomain locationDomain) {
